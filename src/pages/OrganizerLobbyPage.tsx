...
import { Users, Loader2, Play, LayoutDashboard, Flag, Hash, Copy, CheckCircle2 } from 'lucide-react';
                ...
                <div className="space-y-6 lg:col-span-1">
                    <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Join URL</label>
                            ...
                            <div>
                                <label className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Race Code</label>
                                ...
                                <p className="mt-2 text-xs text-slate-400 text-center">Share this code with your participants</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="divide-y divide-slate-100">
                            {teams.length === 0 ? (
                                ...
                                teams.map((team, index) => (
                                    <div key={team.id} className="flex items-center justify-between px-6 py-4 transition-colors hover:bg-slate-50">
                                        <div className="flex items-center gap-4">
