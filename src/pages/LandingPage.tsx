import { Map as MapIcon, Trophy, Zap } from 'lucide-react';
			...
			<section className="py-12 lg:py-20">
				<div className="text-center">
					...
					<p className="mx-auto mb-10 max-w-2xl text-xl text-slate-600 sm:text-2xl">
						Organize and run interactive scavenger hunts. No app download required. Just pure
						excitement and location-based challenges.
					</p>
